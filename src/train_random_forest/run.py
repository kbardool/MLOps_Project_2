...
def go(args):
    ...
    logger.info(f"Retrieving  {args.trainval_artifact} ...")    
...
def export_model(model, X, y, export_dir):
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    id                  : Not used - Dropped
    name
    host_id             : Not Used - Dropped
    host_name,
    neighbourhood_group : Non-ordinal Categorical Preprocessing
    neighbourhood
    latitude            : Zero Impute Preprocessing
    longitude           : Zero Impute Preprocessing
    room_type           : Ordinal Categorical Preprocessing
    minimum_nights      : Zero Impute Preprocessing
    number_of_reviews   : Zero Impute Preprocessing
    reviews_per_month   : Zero Impute Preprocessing
    calculated_host_listings_count : Zero Impute Preprocessing
    availability_365    : Zero Impute Preprocessing
    last_review         : Date Imputer
    """
    ######################################
    ...
    # 1-  a step called "preprocessor" applying the  ColumnTransformer instance that we 
    #     saved in the `preprocessor` variable,
    #  
    # 2-  a step called "random_forest" with the random forest instance that we just
    #     saved in the `random_forest` variable.
    #
