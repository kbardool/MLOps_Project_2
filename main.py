...
def go(config: DictConfig):
    ...
    print(f"steps_par is : {steps_par}")
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "basic_cleaning" in active_steps:
            ...
            _ = mlflow.run(
                f"{os.path.join(cwd_path,'src','basic_cleaning')}",
                "main",
                parameters={
        ...
        if "data_check" in active_steps:
            # Preprocess downloaded dataset 
            _ = mlflow.run(
                f"{os.path.join(cwd_path,'src','data_check')}",
                "main",
                parameters={
        ...
        if "train_random_forest" in active_steps:
            ...
            # step
            _ = mlflow.run(
                f"{os.path.join(cwd_path,'src','train_random_forest')}",
                "main",
                parameters={
